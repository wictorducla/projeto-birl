...
function msg() {
	alert("Mensagem registrada, em breve entratemos em contato");
}
...
document.getElementById('contatoForm').addEventListener('submit', function () {
    ...
    var mensagem = this.querySelector('input[name=message]'), mensagem = message.value;
    var texto = 'Olá destinatário, \nMeu nome é '+ nome +' e meu email é '+ email + ' e eu gostaria de...'+ mensagem;
